...
# Построение графика
ax.plot(theta, r, label='Ручной')
ax.plot(theta, r, label='Встроенный', linestyle='dashed', linewidth=0.5)  # Установка толщины линии равной 2
# Добавление легенды
ax.legend()
plt.title('График x(t) ручного и встроенного метода Adams3')
